...
SOURCES_CPP20 := $(wildcard beacon_cpp20/*.cpp)

BEACON_DIR := "beacon"
BEACON_CPP20_DIR := "beacon_cpp20"
FILES_DIR := "files"
HTTP_DIST_DIR := "objects_http"
SMB_DIST_DIR := "objects_smb"
TCP_DIST_DIR := "objects_tcp"
HTTP_DIST_DIR_CPP20 := "objects_http_cpp20"
SMB_DIST_DIR_CPP20 := "objects_smb_cpp20"
TCP_DIST_DIR_CPP20 := "objects_tcp_cpp20"
...
HTTP_OBJECTS_X64_CPP20 := $(patsubst beacon_cpp20/%.cpp, $(HTTP_DIST_DIR_CPP20)/%.x64.o, $(SOURCES_CPP20))
HTTP_OBJECTS_X86_CPP20 := $(patsubst beacon_cpp20/%.cpp, $(HTTP_DIST_DIR_CPP20)/%.x86.o, $(SOURCES_CPP20))

SMB_OBJECTS_X64_CPP20 := $(patsubst beacon_cpp20/%.cpp, $(SMB_DIST_DIR_CPP20)/%.x64.o, $(SOURCES_CPP20))
SMB_OBJECTS_X86_CPP20 := $(patsubst beacon_cpp20/%.cpp, $(SMB_DIST_DIR_CPP20)/%.x86.o, $(SOURCES_CPP20))

TCP_OBJECTS_X64_CPP20 := $(patsubst beacon_cpp20/%.cpp, $(TCP_DIST_DIR_CPP20)/%.x64.o, $(SOURCES_CPP20))
TCP_OBJECTS_X86_CPP20 := $(patsubst beacon_cpp20/%.cpp, $(TCP_DIST_DIR_CPP20)/%.x86.o, $(SOURCES_CPP20))
...
COMMON_FLAGS_CPP20 := -I $(BEACON_CPP20_DIR) \
                      -fpermissive \
                      -w \
                      -masm=intel \
                      -fPIC \
...
.PHONY: all clean pre x64 x86 all-cpp20 clean-cpp20 pre-cpp20 x64-cpp20 x86-cpp20
...
all-cpp20: clean-cpp20 pre-cpp20 x64-cpp20 x86-cpp20
    @ echo "C++20 Beacon build completed successfully"

clean-cpp20:
    @rm -rf $(HTTP_DIST_DIR_CPP20) $(SMB_DIST_DIR_CPP20) $(TCP_DIST_DIR_CPP20)
    @mkdir -p $(HTTP_DIST_DIR_CPP20) $(SMB_DIST_DIR_CPP20) $(TCP_DIST_DIR_CPP20)

pre-cpp20: clean-cpp20
    @ cp $(FILES_DIR)/config.tpl $(HTTP_DIST_DIR_CPP20)/config.cpp
    @ cp $(FILES_DIR)/stub.x64.bin $(HTTP_DIST_DIR_CPP20)/stub.x64.bin
    @ cp $(FILES_DIR)/stub.x86.bin $(HTTP_DIST_DIR_CPP20)/stub.x86.bin
    @ cp $(FILES_DIR)/config.tpl $(SMB_DIST_DIR_CPP20)/config.cpp
    @ cp $(FILES_DIR)/stub.x64.bin $(SMB_DIST_DIR_CPP20)/stub.x64.bin
    @ cp $(FILES_DIR)/stub.x86.bin $(SMB_DIST_DIR_CPP20)/stub.x86.bin
    @ cp $(FILES_DIR)/config.tpl $(TCP_DIST_DIR_CPP20)/config.cpp
    @ cp $(FILES_DIR)/stub.x64.bin $(TCP_DIST_DIR_CPP20)/stub.x64.bin
    @ cp $(FILES_DIR)/stub.x86.bin $(TCP_DIST_DIR_CPP20)/stub.x86.bin

x64-cpp20: $(HTTP_OBJECTS_X64_CPP20) $(SMB_OBJECTS_X64_CPP20) $(TCP_OBJECTS_X64_CPP20)
    @ echo "C++20 x64 compilation completed"

x86-cpp20: $(HTTP_OBJECTS_X86_CPP20) $(SMB_OBJECTS_X86_CPP20) $(TCP_OBJECTS_X86_CPP20)
    @ echo "C++20 x86 compilation completed"

$(HTTP_DIST_DIR_CPP20)/%.x64.o: beacon_cpp20/%.cpp
    @x86_64-w64-mingw32-g++ -c $(COMMON_FLAGS_CPP20) -D BEACON_HTTP -c $< -o $@

$(HTTP_DIST_DIR_CPP20)/%.x86.o: beacon_cpp20/%.cpp
    @i686-w64-mingw32-g++ -c $(COMMON_FLAGS_CPP20) -D BEACON_HTTP -c $< -o $@

$(SMB_DIST_DIR_CPP20)/%.x64.o: beacon_cpp20/%.cpp
    @x86_64-w64-mingw32-g++ -c $(COMMON_FLAGS_CPP20) -D BEACON_SMB -c $< -o $@

$(SMB_DIST_DIR_CPP20)/%.x86.o: beacon_cpp20/%.cpp
    @i686-w64-mingw32-g++ -c $(COMMON_FLAGS_CPP20) -D BEACON_SMB -c $< -o $@

$(TCP_DIST_DIR_CPP20)/%.x64.o: beacon_cpp20/%.cpp
    @x86_64-w64-mingw32-g++ -c $(COMMON_FLAGS_CPP20) -D BEACON_TCP -c $< -o $@

$(TCP_DIST_DIR_CPP20)/%.x86.o: beacon_cpp20/%.cpp
    @i686-w64-mingw32-g++ -c $(COMMON_FLAGS_CPP20) -D BEACON_TCP -c $< -o $@
